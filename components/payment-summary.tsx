...
export default function PaymentSummary({ packageName, price, keyFeatures, packageSlug }: PaymentSummaryProps) {
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold mb-4">Purchase the {packageName}</h2>
            <p className="text-xl text-gray-300">Ready to transform your fitness business?</p>
          </div>
