        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          <div className="space-y-8">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight">
              Web Platforms That <span className="text-[#004d40]">Scale</span>{" "}
              With Your <span className="text-[#004d40]">Fitness Business</span>
            </h1>

            <p className="text-xl text-gray-300 leading-relaxed">
              Custom scheduling, payments, and smart automation – everything
              fitness trainers need to grow.
            </p>
